...
//    }
    ...
    public boolean forElementBeingInvisible(By by, long timeout, TimeUnit unit) {
        return new WebDriverWait(driver, unit.toMillis(timeout), DEFAULT_SLEEP_MILLISECONDS)
                .until(new ExpectedConditionElementToBeInvisible(by));
    }

    public WebElement forElementBeingVisible(WebElement element) {
        return new WebDriverWait(driver, DEFAULT_TIMEOUT_MILLISECONDS, DEFAULT_SLEEP_MILLISECONDS)
    ...
    public WebElement forElementBeingPresentPageLoadingTimeout(By by) {
        return new WebDriverWait(driver, TIMEOUT_PAGE_LOADING_MILLISECONDS, DEFAULT_SLEEP_MILLISECONDS)
